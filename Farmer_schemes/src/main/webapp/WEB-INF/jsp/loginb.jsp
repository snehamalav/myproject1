...
<body>
          ...
          <div class="topnav">
            ...
            <a href="Logoutb.do">Logout</a>
            <!-- <a href="#" style="float:right">Link</a> -->
          </div>
          <center>
            <H2> Bidder Login</H2>
      <form action = "loginProcess1.do" name = "login" method = "post">
            ...
            <div class="container">
              ...
              <input type="text" placeholder="Enter Userid" name="b_email" id = 'username' required>
        <br>
