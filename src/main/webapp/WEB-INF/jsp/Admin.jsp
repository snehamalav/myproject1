...
h3 {color:antiquewhite; font-size:28px;margin-bottom:24px;}
    ...
    <body>  
            ...
            <div class="topnav">
                  ...
                  <button><input type="submit" value="View All Farmer Request" /></button></form>
                  <form action="viewbidder.do" method="get">
                  <button><input type="submit" value="View All Bidder Request " /></button></form>
                  <form action="searchfarmer.do" method="get">
                  <button><input type="submit" value="Search Farmer to Approve" /></button></form>
                  <form action="searchbidder.do" method="get">
                  <button><input type="submit" value="Search Bidder to Approve" /></button></form>
